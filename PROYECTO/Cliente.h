...
public:
    Cliente(string, string, string, int,int,int,bool);
    ~Cliente();
...
Cliente::Cliente(string name, string user, string password, int phone,int Viajes, int ViajesCancelados,bool AccesoPromociones):Persona(name,user,password,phone){
 viajes= Viajes;
