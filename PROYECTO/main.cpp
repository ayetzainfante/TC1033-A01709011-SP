        ...
        cin>> opcion;
            ...
            break;
                ...
                if (respuesta=="1")
                    ...
                    cout <<"Hora de envio: "<<pRetenido.getHora()<<endl;
                    cin>>hora;
                    cout <<"Pais de envio: "<<pRetenido.getPaises()<<endl;
                    cin>>country;
                    cout<<"Motivo: "<<pRetenido.getMotivo()<<endl;
                    cin>>motivo;
                    cout<<"Tiene Multa: "<<pRetenido.getMulta()<<endl;
                    }
                else if(respuesta=="2")
                    {
                    ...
                    cout<<"Escriba el Remitente: "<<pEnvio.getRemitente()<<endl;
                    cout<<" ";
                    cin >>remitente;
                    cout <<"Escriba el nombre del Destinatario: "<<pEnvio.getRemitente()<<endl;
                    cout<<" ";
                    cin>>destinatario;
                    cout<<"Escriba el pais,estado y ciudad de provinencia: "<<pEnvio.getRemitenteLugar()<<endl;
                    cout<<" ";
                    cin>>remitenteLugar;
                    cout<<"Escriba el pais, estado y ciudad al que va: "<<pEnvio.getDestinatarioLugar()<<endl;
                    cout<<" ";
                    ...
                    cout<<" ";
                    cin>>name;
                    cout <<"Ingrese el valor monetario del producto: "<<endl;
                    cout<<" ";
                    cin>>valor;
                ...
                else if(respuesta=="2")
                {
                    ...
                    cout <<"Introduzca su primer nombre y primer apellido: "<<endl;
                    cout<<" ";
                    cin>>name;
                    ...
                    cout<<"Vuelva a entrar a la paguna"<<endl;
                    break;
                }
    }
    else if (opcion ==5)
